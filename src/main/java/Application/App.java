...
//UPDATE employees SET email = 'correo@example.com' WHERE emp_no = 1;  para introducir a la base de datos


//INSERT INTO employees (emp_no, first_name, last_name, email, birth_date, role, salary) VALUES (1, 'John', 'Doe', 'johndoe@example.com', '1990-01-01', 'Manager', 5000); para introducir nuevo¡o empleado